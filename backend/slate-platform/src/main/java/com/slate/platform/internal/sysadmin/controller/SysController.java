...
public class SysController {
    ...
    public DictType createDictType(@RequestBody CreateDictTypeRequest request) {
    ...
    public void upsertDictItem(@PathVariable String type, @RequestBody UpsertDictItemRequest request) {
    ...
    public record CreateDictTypeRequest(@NotBlank String code, @NotBlank String name, String remark) {
    }

    public record UpsertDictItemRequest(@NotBlank String value, @NotBlank String label, Integer sort) {
    }
    ...
    public void upsertConfig(@RequestBody UpsertConfigRequest request) {
    ...
    public record UpsertConfigRequest(@NotBlank String key, @NotBlank String value, String scope, String remark) {
    }
